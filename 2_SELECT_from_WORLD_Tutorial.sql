...
select name, gdp/population as capitagdp
  from world
  where population >= 200000000
...
select name, population/1000000
  from world
  where continent like 'south ame%'
...
select name, 
  round(population/1000000,2) as 'population/mill', 
  round(gdp/1000000000,2) as 'gdp/bill'
from world
where continent like 'south ame%'
...
select name, round(gdp/population,-3) as capitagdp
  from world
